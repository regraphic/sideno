...
function __wbg_adapter_24(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha6a6d504cb99ebb0(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_80(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__hbc3fb10986bf1462(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class SiFont {
    ...
    */
    constructor(src, src_bytes) {
        const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(src_bytes) ? 0 : passArray8ToWasm0(src_bytes, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.sifont_new(ptr0, len0, ptr1, len1);
...
export class SiImage {
    ...
    */
    constructor(image_url, font, image_bytes) {
        const ptr0 = passStringToWasm0(image_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        _assertClass(font, SiFont);
        var ptr1 = font.__destroy_into_raw();
        var ptr2 = isLikeNone(image_bytes) ? 0 : passArray8ToWasm0(image_bytes, wasm.__wbindgen_malloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.siimage_new(ptr0, len0, ptr1, ptr2, len2);
        return takeObject(ret);
    }
    /**
    ...
    * @returns {SiImage}
    */
    text(text, text_scale, pos_x, pos_y, color) {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(color) ? 0 : passStringToWasm0(color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.siimage_text(this.__wbg_ptr, ptr0, len0, text_scale, pos_x, pos_y, ptr1, len1);
    ...
    */
    get as_bytes() {
        try {
            ...
            wasm.siimage_as_bytes(retptr, this.__wbg_ptr);
    ...
    */
    set font(font) {
        ...
        const ret = wasm.siimage_set_font(this.__wbg_ptr, ptr0);
        return SiImage.__wrap(ret);
    }
    /**
...
const imports = {
    __wbindgen_placeholder__: {
        ...
        __wbg_fetch_381efb5e862610fa: function(arg0) {
