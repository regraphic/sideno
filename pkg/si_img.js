...
export class SiImage {
    ...
    */
    constructor(src, font) {
        ...
        const ret = wasm.siimage_from_vec(ptr0, len0, ptr1);
    ...
    */
    static from_network_async(image_url, font) {
        const ptr0 = passStringToWasm0(image_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        _assertClass(font, SiFont);
        var ptr1 = font.__destroy_into_raw();
        const ret = wasm.siimage_from_network_async(ptr0, len0, ptr1);
        return takeObject(ret);
    }
    /**
    * Placeholder method for when blocking feature is not enabled.
    ...
    * @param {SiFont} font
    */
    static from_network(image_url, font) {
        const ptr0 = passStringToWasm0(image_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        _assertClass(font, SiFont);
        var ptr1 = font.__destroy_into_raw();
        wasm.siimage_from_network(ptr0, len0, ptr1);
    }
    /**
...
const imports = {
    __wbindgen_placeholder__: {
        ...
        __wbindgen_closure_wrapper672: function(arg0, arg1, arg2) {
