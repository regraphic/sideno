...
* @returns {SiImage}
*/
  text(text: string, text_scale: number, pos_x: number, pos_y: number, color: string | undefined, using_font: SiFont, options: TextOptions): SiImage;
/**
